<template>
  <div class="sidebar" :class="{showSidebar: showSidebar}">
    <div class="sidebar-con" :class="{showbar: showSidebar}">
      <div class="head">
        <div class="avatar">
          <img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1561046766590&di=17072a311f48b6b871f5c75c6813e642&imgtype=0&src=http%3A%2F%2Fimg.juimg.com%2Ftuku%2Fyulantu%2F110713%2F84-110G316340479.jpg" />
        </div>
        <div class="name">月夜</div>
      </div>
      <div class="menu">
        <ul>
          <li>
